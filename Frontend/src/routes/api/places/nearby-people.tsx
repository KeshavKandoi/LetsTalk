...
import { getNearbyPlacePeopleLite } from '@backend/lib/app-state'
import { auth } from '@backend/lib/auth'

export const Route = createFileRoute('/api/places/nearby-people')({
  server: {
    handlers: {
      POST: async ({ request }) => {
        try {
          ...
          const result = await getNearbyPlacePeopleLite(body)
