...
import { respondToConnectRequest, sendConnectRequest } from '@backend/lib/app-state'
import { auth } from '@backend/lib/auth'

export const Route = createFileRoute('/api/places/connect-request')({
  server: {
    handlers: {
      POST: async ({ request }) => {
        try {
          ...
          const result = body.action && body.action !== 'send'
